...
@router.get(
    ...
    description=(
        "**Устарела, используйте `GET /statistics/schedule-execution`.**\n\n"
        ...
        "Отличия новой ручки: ТО, закрытое в следующем месяце, засчитывается "
        "плановому месяцу и помечается просрочкой, а не теряется; работают "
        "фильтры по участку, организации и компании; прорабов у участка может "
        "быть несколько."
    ),
    deprecated=True,
