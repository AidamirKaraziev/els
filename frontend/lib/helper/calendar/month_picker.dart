...
/// Месяцы в родительном падеже — для дат вида «12 мая 2026».
///
/// Тот же довод, что и выше: русская локаль `intl` здесь явно не
/// инициализируется, и `DateFormat('d MMMM', 'ru')` однажды упадёт в проде.
const List<String> kMonthsGenitive = <String>[
  'января',
  'февраля',
  'марта',
  'апреля',
