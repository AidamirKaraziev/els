...
class TaskPageCompletedForeman extends StatefulWidget {
  const TaskPageCompletedForeman({Key? key}) : super(key: key);

  @override
  State<TaskPageCompletedForeman> createState() => _TaskPageCompletedForemanState();
}

class _TaskPageCompletedForemanState extends State<TaskPageCompletedForeman> {
                        ...
                        children: [
                          Container(
                            ...
                            child: IconButton(
                                onPressed: () {
                                  setState(() {
                                    IntTest.indexScreensForeman = listSelectedTaskIdForeman['data']['status_id']['id'] != 4 ? 2 : 16;
