...
class SchedulePageForeman extends StatefulWidget {
  const SchedulePageForeman({Key? key}) : super(key: key);

  @override
  State<SchedulePageForeman> createState() => _SchedulePageForemanState();
}
...
class _SchedulePageForemanState extends State<SchedulePageForeman> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewObjectPage = listSelectedScheduleForeman['data'];
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      if(getTOScheduleList.isNotEmpty){
                                        ...
                                        // listTOJanuaryText = listTOJanuary['step_list'];
                                        // print('step list fact  ==========================================================================================================');
                                        // print('год список плановых ТО по id объекта ${listTOJanuaryText}');
                                        // print('==============================================================================================================');
                                      }
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Icon(Icons.circle,color: listToText['bool'] == false ? Colors.red : Colors.green,),
                                                          const SizedBox(width: 10.0),
