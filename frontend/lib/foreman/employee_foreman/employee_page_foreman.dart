...
class OpenViewEmployeeForeman extends StatefulWidget {
  const OpenViewEmployeeForeman({Key? key}) : super(key: key);

  @override
  State<OpenViewEmployeeForeman> createState() => _OpenViewEmployeeForemanState();
}
...
class _OpenViewEmployeeForemanState extends State<OpenViewEmployeeForeman> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewEmployeeList = listSelectedEmployeeForeman;
