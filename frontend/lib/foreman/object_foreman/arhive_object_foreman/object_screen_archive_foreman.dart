...
class ObjectScreenArchiveForeman extends StatefulWidget {
  const ObjectScreenArchiveForeman({Key? key}) : super(key: key);

  @override
  State<ObjectScreenArchiveForeman> createState() => _ObjectScreenArchiveForemanState();
}

class _ObjectScreenArchiveForemanState extends State<ObjectScreenArchiveForeman> {
                                  ...
                                  return dataObjectScreen['is_actual'] != false
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          ...
                                          myStream.add(IntTest.indexScreensForeman);
                                          IntTest.indexScreensForeman = 13;
                                          setState(() {});
                                        },
                                        child: Container(
                                          decoration: BoxDecoration(
