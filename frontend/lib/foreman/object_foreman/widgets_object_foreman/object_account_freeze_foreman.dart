import 'package:els/foreman/object_foreman/object_page_foreman.dart';
...
class ObjectAccountFreezeForeman extends StatelessWidget {
  const ObjectAccountFreezeForeman({Key? key}) : super(key: key);
        ...
        Row(
          children: [
            ...
            ElevatedButton(
                ...
                onPressed: () async {
                  // await freezingObjectForeman(IntTest.pressHover);
