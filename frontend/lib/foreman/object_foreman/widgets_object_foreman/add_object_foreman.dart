...
getTreatyObjectList() async {
  ...
  // print('получение из Обьектов $getTreatyList');
}
String? getTreatyTitle;
List getTreatyList = [];
/// ==============================

class AddObjectForeman extends StatefulWidget {
  const AddObjectForeman({
    Key? key,
  }) : super(key: key);

  @override
  State<AddObjectForeman> createState() => _AddObjectForemanState();
}
                      ...
                      child: SizedBox(
                        ...
                        child: DropdownButtonFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              //                       content: AddContactPersonObject())).then((value) => setState(() {}));
                              //       });
                              //     },
                              //     icon: const Icon(Icons.add_box_rounded,
                              //         size: 20.0,
