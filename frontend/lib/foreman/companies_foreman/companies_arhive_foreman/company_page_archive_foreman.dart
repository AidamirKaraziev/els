...
import '../../../screns/companies/widgets/ContactFaces.dart';
...
class CompanyPageArchiveForeman extends StatefulWidget {
  const CompanyPageArchiveForeman({Key? key}) : super(key: key);

  @override
  State<CompanyPageArchiveForeman> createState() => _CompanyPageArchiveForemanState();
}

class _CompanyPageArchiveForemanState extends State<CompanyPageArchiveForeman> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewCompanyListArchive = listSelectedCompanyForeman['data'];
