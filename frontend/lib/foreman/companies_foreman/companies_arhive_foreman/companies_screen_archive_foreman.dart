...
class CompaniesScreenArchiveForeman extends StatefulWidget {
  const CompaniesScreenArchiveForeman({
    Key? key,
  }) : super(key: key);

  @override
  State<CompaniesScreenArchiveForeman> createState() => _CompaniesScreenArchiveForemanState();
}
...
class _CompaniesScreenArchiveForemanState extends State<CompaniesScreenArchiveForeman> {
                      ...
                      Text('Архив компаний',
                          style: TextStyle(
                              ...
                              fontWeight: size.width > 350
                                  ? FontWeight.w700
                                  : FontWeight.w500)),
                      /// Кнопка Кнопка архив, Поиск Компании
                      Row(
                        children: [
                          const SizedBox(width: 10.0),
