...
List listSelectedAccountCompanyForeman = [];

List listSelectedObjectCompanyForeman = [];

List listSelectedContactPersonCompanyForeman = [];
...
getAccountCompanyForeman(int numberCompany) async {
  await Future(() async {
    ...
    print('список акаунтов компании : $listSelectedAccountCompanyForeman');
...
getListObjectCompanyForeman(int numberCompany) async {
  await Future(() async {
    ...
    print('список обьектов компании : ${listSelectedObjectCompanyForeman.length}');
    myStream.add(IntTest.indexScreens);
  });
}
/// ======================================================
...
class CompanyPageForeman extends StatefulWidget {
  const CompanyPageForeman({Key? key}) : super(key: key);

  @override
  State<CompanyPageForeman> createState() => _CompanyPageForemanState();
}


class _CompanyPageForemanState extends State<CompanyPageForeman> {

  @override
  void initState() {
    getContactPersonCompanyForeman();
    getAccountCompanyForeman(IntTest.pressHover);
    getListObjectCompanyForeman(IntTest.pressHover);
  ...
  Widget build(BuildContext context) {
    ...
    final viewCompanyList = listSelectedCompanyForeman['data'];
                        ...
                        Column(
                          children: [
                            ...
                            Row(
                              children: [
                                /// Лого
                                if (listSelectedCompanyForeman['data']['is_actual'] == true)
                                  Container(
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(5.0),
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      //       onPressed: () async {
                                      //         await defrostingCompanyForeman(IntTest.pressHover);
                            ...
                            Row(
                              children: const [
                                ...
                                Expanded(
                                  flex: 3,
                                  child: DisplayAccountCompanyForeman(),
                                ),
                                SizedBox(width: 20.0),
                                ...
                                Expanded(
                                  flex: 3,
                                  child:
                                  AddObjectSelectedCompanyForeman(),
                                ),
                                SizedBox(width: 20.0),
