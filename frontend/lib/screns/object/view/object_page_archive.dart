...
import '../../../helper/letter_of_appointment.dart';
...
class ObjectPageArchive extends StatefulWidget {
  const ObjectPageArchive({Key? key}) : super(key: key);

  @override
  State<ObjectPageArchive> createState() => _ObjectPageArchiveState();
}



class _ObjectPageArchiveState extends State<ObjectPageArchive> {
  @override
  void initState() {
                                      ...
                                      Column(
                                              ...
                                              children: [
                                                ...
                                                ElevatedButton(
                                                    ...
                                                    child: const Text('Разморозить объект',style: TextStyle(color: Colors.white),)),
                                                const Gap(2.0),
                                              ],
                                            ),
                                      const Gap(10.0),
