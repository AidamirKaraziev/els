...
class OpenViewEmployeeArchive extends StatefulWidget {
  const OpenViewEmployeeArchive({Key? key}) : super(key: key);

  @override
  State<OpenViewEmployeeArchive> createState() => _OpenViewEmployeeArchiveState();
}
...
class _OpenViewEmployeeArchiveState extends State<OpenViewEmployeeArchive> {
  @override
  Widget build(BuildContext context) {
    final Size size = MediaQuery.of(context).size;
    final viewEmployeeListArchived = listSelectedEmployeeArchived['data'];
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //                                           EmployeeBloc()
                        //                                               .add(
                        //                                               EmployeeGetUserEvent());
                        //                                           IntTest.indexScreens =
                        //                                           6;
                        //                                           myStream.add(
                        //                                               IntTest
                        //                                                   .indexScreens);
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            viewEmployeeListArchived['email'] == null
                                                ? const Text('')
                                                : Text(
                                              '${viewEmployeeListArchived['email']}',
                                              style: const TextStyle(
                                                  fontWeight:
                                                  FontWeight.w600),
                                            ),
