...
getListEmployeeArchived() async{
  ...
  // print('Архтв >>>>>>>>>>${listArchivedEmployees}');
  myStream.add(IntTest.indexScreens);
  // print('Архтв >>>>>>>>>>${listArchivedEmployees[0]['name']}');
}
/// ==================================

///Сотрудники ================================================================
class EmployeesArchiveScreen extends StatefulWidget {
  ...
  @override
  State<EmployeesArchiveScreen> createState() => _EmployeesArchiveScreenState();
}

class _EmployeesArchiveScreenState extends State<EmployeesArchiveScreen> {
  ...
  getListEmployeesInfoArchived(int userId) async {
    await Future(() async {
      ...
      print(' ${listSelectedEmployeeArchived['data']}');
      // print('Дата рождения ${listSelectedEmployee['data']}');
      // print('Дата приема на работу ${listSelectedEmployee['data']['date_of_employment']}');
    });
  }
  /// ================================================
  ...
  void _runEmployeeFilter(String enteredKeyword) {
    ...
    if(enteredKeyword.isEmpty){
      ...
      result = getEmployee.where((user) => user['name'].toLowerCase().contains(enteredKeyword.toLowerCase())).toList();
    }
    setState(() {
      dataEmployee = result;
    });
  ...
  @override
  void initState() {
    // getListEmployeeArchived();
    // dataEmployee = listArchivedEmployees;
    // print(getEmployee);
                            ...
                            children: [
                              TopButtonWidget(
                                ...
                                press: () {
                                  myColorButton = 2;
                                  setState(() {
                                    print(getEmployee[0]['division_id']['id']);
                                  });
                                },
                                pressIcon: () {},
                                colorButton: ColorApp.myColorWhite,
                      ...
                      return  employeeArchived['is_actual'] != false
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              await getListEmployeesInfoArchived(employeeArchived['id']);
                              myStream.add(IntTest.indexScreens);
                              IntTest.indexScreens = 16;
                              setState(() {});
                            },
                            onHover: (val) {
                              setState(() {
                                              ...
                                              child: StreamBuilder(
                                                ...
                                                builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                                                  return CircleAvatar(
                                                    ...
                                                    apiImage(employeeArchived['photo']),
