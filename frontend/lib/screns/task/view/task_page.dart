...
class _TaskPageState extends State<TaskPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewTaskPage = listSelectedTaskId['data'];
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            const Text('Назначенный исполнитель',
                                                style:
                                                TextStyle(fontWeight: FontWeight.w300, fontSize: 12)),
                                            const SizedBox(height: 5.0),
                                            SizedBox(
                                              width: 180.0,
                                              child: Text(viewTaskPage['executor_id'] == null ? 'Удален'
                            ...
                            Column(
                              ...
                              children: [
                                /// Перенести дату
                                // ElevatedButton(
                                //   style: ElevatedButton.styleFrom(backgroundColor: ColorApp.myColorGreenAuth),
                                //     onPressed: () async {
                                //       final DateTime? dateTime = await showDatePicker(
                                //           context: context,
                                //           initialDate: newDateTasks,
                                //           firstDate: DateTime(2000),
                                //           lastDate: DateTime(3000));
                                //       if (dateTime != null) {
                                //         newDateTasks = dateTime;
                                //         setState(() {});
                                //       }
                      ...
                      : Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            /// Объект
                            viewTaskPage['object_id'] == null ? const Text('') : IconAndText(
                                icon: Icons.home_work_outlined,
                                title: 'Объект',
                                subtitle: viewTaskPage['object_id']['name'].toString() ?? ''),
                            /// Задача
                            viewTaskPage['task_text'] == null ? const Text('') : IconAndText(
                                icon: Icons.build_circle_outlined,
                                title: 'Задача',
                                subtitle: '${viewTaskPage['task_text']}' ?? ''),
                            /// Категория неисправности, Фото, Назначенный исполнитель
                            viewTaskPage['status_id']['id'] == null ? const Text('') :  IconAndText(
                                icon: Icons.run_circle_outlined,
                                title: 'Статус',
                                subtitle:
                                '${viewTaskPage['status_id']['name']}' ?? ''),
                      ...
                      /// Коментарий к задаче Фото к задаче
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const SizedBox(height: 20.0),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(viewTaskPage['commentary'] == null ?'':'${viewTaskPage['commentary']}'),
                              ),
                            ],
                          ),
                          const SizedBox(width: 20.0),
                          /// Фото к задаче
                          if(photoSelectedTaskId.isNotEmpty)
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const SizedBox(height: 20.0),
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: photoSelectedTaskId.length,
                                    itemBuilder: (context, index) {
                                      final photoTask = photoSelectedTaskId[index];
                                      return InkWell(
                                        onTap: () async {
