...
class TaskPageArchive extends StatefulWidget {
  const TaskPageArchive({Key? key}) : super(key: key);

  @override
  State<TaskPageArchive> createState() => _TaskPageArchiveState();
}

class _TaskPageArchiveState extends State<TaskPageArchive> {
                        ...
                        children: [
                          Container(
                            ...
                            child: IconButton(
                                onPressed: () {
                                  setState(() {
                                    IntTest.indexScreens = listSelectedTaskId['data']['status_id']['id'] != 4 ? 2 : 21;
