...
class _EditingTaskState extends State<EditingTask> {
  ...
  /// Новоя задача
  TextEditingController newCommentTask = TextEditingController(text: '${listSelectedTaskId['data']['task_text']}');
  ...
  void initState() {
    ...
    dateTask = DateTime.fromMillisecondsSinceEpoch(listSelectedTaskId['data']['created_at']*1000);
    newTaskObjectTitle = '${listSelectedTaskId['data']['object_id']['id']}';
    executorTitle = '${listSelectedTaskId['data']['executor_id']['id']}';
    statusTitle = '${listSelectedTaskId['data']['status_id']['id']}';
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: DropdownButtonFormField(
                    value: executorTitle,
                    hint: Text('${listSelectedTaskId['data']['executor_id']['id']}'),
                    onChanged: (newValue1) async {
                      setState(() {
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: DropdownButtonFormField(
                    value: statusTitle,
                    hint: Text('${listSelectedTaskId['data']['status_id']['name']}'),
                    onChanged: (newValue1) async {
                      setState(() {
            ...
            Column(
              ...
              children: [
                MainButtonApp(textButton: 'Сохранить', press: () async {
                  await editingTask(IntTest.pressHover);
                  /// Новая задача
                  listSelectedTaskId['data']['task_text'] = newCommentTask.text;
                  /// Новая дата
                  listSelectedTaskId['data']['created_at'] = dateTask.millisecondsSinceEpoch/1000;
                  /// Новый исполнитель
                  listSelectedTaskId['data']['executor_id']['name'] = testTask['data']['executor_id']['name'];
                  /// Новый статус
                  listSelectedTaskId['data']['status_id']['id'] = testTask['data']['status_id']['id'];
                  /// Новый оъект
                  listSelectedTaskId['data']['object_id']['name'] = testTask['data']['object_id']['name'];
                  await getListTask();
