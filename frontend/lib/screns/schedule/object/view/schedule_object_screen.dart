...
///
/// Экран заводился **рядом** со старым `SchedulePage` подрядчика: тот был в
/// проде, и переключать на новый было нечего, пока новый не показывал график.
/// С 3 сентября 2026 года он единственный: страницы подрядчика сняты (S2.6).
...
class _Content extends StatelessWidget {
  ...
  ///
  /// Заготовку и расстановку мастер делает сам: `true` означает «график уже
  /// создан», с тем месяцем начала цикла, который человек выбрал. Экрану
  /// остаётся перечитать ленту года — расставлять второй раз тут нечего.
  ///
