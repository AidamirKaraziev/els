...
abstract class MaintenanceProgramRepository {
  ...
  /// Завести вид ТО в справочнике. Возвращает его уже с `id` — таким он
  /// сразу встаёт на позицию. Имя занято — исключение с текстом сервера.
  Future<TypeAct> createTypeAct(String name);
