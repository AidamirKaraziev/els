...
class SchedulesScreen extends StatefulWidget {
  ...
  ///
  /// Приходит снаружи, от места встраивания: за переходом стоят сетевые
  /// репозитории экрана, и лента о них знать не должна. Пусто — клик по
  /// строке ничего не делает; так лента собирается в тесте и не лезет в сеть.
...
class _SchedulesScreenState extends State<SchedulesScreen> {
  ...
  /// Идёт открытие экрана «График».
  ///
  /// Пока оно идёт, лента закрыта индикатором. Иначе человек, не увидев
  /// отклика, жмёт вторую строку — и уезжает на объект, которого не выбирал.
  /// Маршрут ставится сразу, но входу это знать необязательно: он вправе
  /// сходить в сеть, и тогда ждать придётся по-настоящему.
  bool _opening = false;
  ...
  /// открывается на том же году, что человек смотрел в ленте.
