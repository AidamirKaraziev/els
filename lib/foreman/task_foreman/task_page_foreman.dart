...
import 'package:els/foreman/task_foreman/task_widget_foreman/editing_tesk_foreman.dart';
...
class TaskPageForeman extends StatefulWidget {
  const TaskPageForeman({Key? key}) : super(key: key);

  @override
  State<TaskPageForeman> createState() => _TaskPageForemanState();
}

class _TaskPageForemanState extends State<TaskPageForeman> {
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                            ...
                                            width: 230,
                                            height: 230,
                                            child: photoTask['photo'] == null ? const CircularProgressIndicator() : Image.network('http://${photoTask['photo']}',fit: BoxFit.cover)
                                        ),
                                      );
                                    },
                                  ),
