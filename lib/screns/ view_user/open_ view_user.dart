...
import '../employee/widgets/employee_acount_freeze.dart';
import 'package:http/http.dart' as http;

/// api/v1/cp/admin/2/unzip/
/// http://185.119.58.63/api/v1/cp/admin/1/archive/
var freezingUserList = [];
...
freezingUser(int userId) async {
  await Future(() async {
    ...
    print('Данные Заморороженного сотрудника $freezingUserList');
...
defrostingUser(int userId) async {
  await Future(() async {
    ...
    var vova = jsonDecode(utf8.decode(res.bodyBytes));
    listSelectedEmployee = vova;
    print('Данные Разморороженного сотрудника $freezingUserList');
    print(IntTest.pressHover);
  });
}
