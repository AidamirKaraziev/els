                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            /// Лого
                            if (listSelectedCompany['data']['is_actual'] ==
                                true)
                              Container(
                                decoration: BoxDecoration(
                                ...
                                child: Padding(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: const AssetImage('assets/office.png'),
                                                          ...
                                                          const Text('Эл.почта',
                                                              style: TextStyle(
                                                                  fontSize:
                                                                      12)),
                                                          Text(
                                                              '${listSelectedCompany['data']['email']}',
                                                              style: const TextStyle(
                                                                  fontSize: 15,
                                                                  fontWeight:
                                                                      FontWeight
